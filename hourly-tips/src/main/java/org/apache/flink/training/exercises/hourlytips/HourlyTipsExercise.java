...
public class HourlyTipsExercise {
    ...
    public JobExecutionResult execute() throws Exception {
        ...
        fares.keyBy((TaxiFare fare) -> fare.driverId)
                .window(TumblingEventTimeWindows.of(Time.hours(1)))  // hour-long windows
                .process(new AggregateHourlyTipFunction())
    ...
    public static class AggregateHourlyTipFunction
